...
library(DBI)
library(RSQLite)
con <- dbConnect(RSQLite::SQLite(), dbname = path_target("PDUI.sqlite"))
```
...
```{r}
# Send a query
res <- dbSendQuery(con, "SELECT * FROM pdui WHERE species = 'rabbit' AND organism = 'heart' AND PDUI>0.999")
